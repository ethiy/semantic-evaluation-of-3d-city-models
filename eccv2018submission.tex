            ...
            \ffigbox{
                ...
                \ffigbox[\FBwidth]
                {
                    \begin{subfloatrow}[4]
                        ...
                        \ffigbox[\FBwidth]{\caption{\tiny \scriptsize Imprecise slope.}\label{fig::slope}}{\includegraphics[height=.11\textheight]{images/Facet_Errors/slope}}
                    \end{subfloatrow}
                }
                {
                	\captionsetup{labelfont={tiny, bf},textfont=scriptsize,justification=raggedright, labelsep=period}
...
\begin{figure}[H]
	\begin{subfigure}{.48\textwidth}
		\includegraphics[width=\textwidth]{images/orthoprojection}
