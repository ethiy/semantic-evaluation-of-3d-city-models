...
\begin{figure}
    ...
    \tiny
		\begin{tabular}{| x{1cm} | x{.75cm} | x{.75cm} || x{.5cm} | x{.75cm} | x{.75cm} || x{1.25cm} | x{.75cm} | x{.75cm} || x{1cm} | x{.75cm} | x{.75cm} |}
			\hline
			\multicolumn{3}{| x{2.5cm} ||}{\raisebox{-.5\height}{\includegraphics[height=.1\textheight]{images/prediction_results/valid_as_bul_over}}} & \multicolumn{3}{ x{2cm} ||}{\raisebox{-.5\height}{\includegraphics[height=.1\textheight]{images/prediction_results/no_imprec_no_fac_over}}} & \multicolumn{3}{ x{2.75cm} ||}{\raisebox{-.5\height}{\includegraphics[height=.1\textheight]{images/prediction_results/no_under_seg}}} & \multicolumn{3}{ x{2cm} |}{\raisebox{-.5\height}{\includegraphics[height=.1\textheight]{images/prediction_results/no_bul_under_seg}}} \\
			\hline
