            ...
            \ffigbox{
                \ffigbox[\FBwidth]
                {
                    \begin{subfloatrow}[4]
                        ...
                        \ffigbox[\FBwidth]{\caption{Under Segmentation.}\label{fig::under_bul}}{\fbox{\includegraphics[width=.24\textwidth]{images/Building_Errors/under_segmentation}}}
                        \ffigbox[\FBwidth]{\caption{Over segmentation.}\label{fig::over_bul}}{\fbox{\includegraphics[width=.24\textwidth, angle=90]{images/Building_Errors/over_segmentation}}}
                        \ffigbox[\FBwidth]{\caption{Inexact footprint.}\label{fig::footprint}}{\fbox{\includegraphics[width=.24\textwidth]{images/Building_Errors/footprint}}}
                        \ffigbox[\FBwidth]{\caption{Imprecise height.}\label{fig::too_low}}{\fbox{\includegraphics[width=.24\textwidth, angle=90]{images/Building_Errors/altimetric}}}
                    \end{subfloatrow}
                }
                {
                ...
                \ffigbox[\FBwidth]
                {
                    \begin{subfloatrow}[4]
                        \captionsetup{labelformat=brace, justification=raggedright}
                        \ffigbox[\FBwidth]{\caption{Under Segmentation.}\label{fig::under_fac}}{\fbox{\includegraphics[width=.24\textwidth]{images/Facet_Errors/under_segmentation}}}
                        \ffigbox[\FBwidth]{\caption{Over segmentation.}\label{fig::over_fac}}{\fbox{\includegraphics[width=.24\textwidth]{images/Facet_Errors/over_segmentation}}}
                        \ffigbox[\FBwidth]{\caption{Mis Segmentation.}\label{fig::mis}}{\fbox{\includegraphics[width=.24\textwidth]{images/Facet_Errors/mis_segmentation}}}
                        \ffigbox[\FBwidth]{\caption{Imprecise slope.}\label{fig::slope}}{\fbox{\includegraphics[width=.24\textwidth]{images/Facet_Errors/slope}}}
                    \end{subfloatrow}
                }
                {
                    \renewcommand\figurename{}
