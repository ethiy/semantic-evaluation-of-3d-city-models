...
\begin{table}
                    ...
                    \begin{center}
                        \begin{tabular}{|x{1.8cm} | x{1.8cm} | x{3cm} | x{2.8cm} | x{2.5cm}|}
                            ...
                            \hline
                            \hline
                            \multirow{4}{*}{Building Errors} & \multirow{4}{*}{$0.823451$} & Over segmentation & $0.8284790$ & $0.6822119$\\
                            \cline{3-5}
                            ...
                            \hline
                            \hline
                            \multirow{4}{*}{Facet Errors} & \multirow{4}{*}{$0.72485$} & Over segmentation & $0.8970588$ & $0.6502332$ \\
                            \cline{3-5}
