...
\begin{table}
                    ...
                    \begin{center}
                        \begin{tabular}{|x{1.8cm} | x{1.8cm} | x{3cm} | x{2.8cm} | x{2.5cm}|}
                            ...
                            \hline
                            \hline
                            \multirow{4}{*}{Building Errors} & \multirow{4}{*}{$ $} & Over segmentation & $ $ & $ $\\
                            \cline{3-5}
                                &                   & Under segmentation & $ $ & $ $ \\
                            \cline{3-5}
                                &                   & Imprecise footprint & $ $ & $ $ \\
                            ...
                            \hline
                            \hline
                            \multirow{4}{*}{Facet Errors} & \multirow{4}{*}{$ $} & Over segmentation & $ $ & $ $ \\
                            \cline{3-5}
                                &                   & Under segmentation & $ $ & $ $ \\
                            \cline{3-5}
...
\begin{table}
	\begin{center}
		\begin{tabular}{x{2cm} x{2cm} x{2cm} x{2cm} x{2cm} x{2cm} x{2cm} x{2cm}}
			\toprule
            \multicolumn{2}{c}{\textbf{Geometric feats.}} & \multicolumn{2}{c}{\textbf{Geometric and Altimetric feats.}} & \multicolumn{2}{c}{\textbf{Geometric and Radiometric feats.}} & \multicolumn{2}{c}{\textbf{All feats.}}\\
            \midrule
            \textbf{Recall} & \textbf{Precision} & \textbf{Recall} & \textbf{Precision} & \textbf{Recall} & \textbf{Precision} & \textbf{Recall} & \textbf{Precision}\\
            \bottomrule
		\end{tabular}
	\end{center}
\end{table}
