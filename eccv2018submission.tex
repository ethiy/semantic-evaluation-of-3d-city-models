...
\begin{figure}
	\begin{center}
    \tiny
		\begin{tabular}{| x{2cm} | x{.75cm} | x{.75cm} | x{2cm} | x{.75cm} | x{.75cm} |}
        	\hline
			\multicolumn{3}{| x{4cm} |}{\includegraphics[height=.1\textheight]{images/prediction_results/valid_as_bul_over}} & \multicolumn{3}{| x{4cm} |}{\includegraphics[height=.1\textheight]{images/prediction_results/valid_as_bul_over}}\\
			\hline
			& \textbf{G.t} & \textbf{Pred.} & & \textbf{G.t} & \textbf{Pred.}\\
            \hline
            & & & & & \\
		\end{tabular}
