...
\begin{table}
	\begin{center}
		\begin{tabular}{x2cm x2cm x2cm x2cm x2cm x2cm x2cm x2cm}
			\toprule
            \multicolumn{2}{c}{Geometric feats.} & \multicolumn{2}{c}{Geometric and Altimetric feats} & \multicolumn{2}{c}{Geometric and Radiometric feats} & \multicolumn{2}{c}{All feats}\\
            \midrule
