...
\begin{table}
	...
	\begin{center}
        \begin{tabular}{|x{1.4cm} | x{1.2cm} x{1.2cm} | x{1.2cm} x{1.2cm} | x{1.2cm} x{1.2cm} | x{1.2cm} x{1.2cm}|}
            ...
            \hline
            Building errors & $0.9976$ & $0.8416$ & $0.9976$ & $0.8411$& $0.9992$ & $0.8384$ & $0.$ & $0.$ \\
            \hline
            Facet errors & $0.9081$ & $0.9802$ & $0.9108$ & $0.9841$& $0.9044$ & $0.9762$ & $0.$ & $0.$ \\
            \hline
		\end{tabular}
	\end{center}
...
\begin{table}
	...
	\begin{center}
        \begin{tabular}{|x{1.4cm} | x{1.2cm} x{1.2cm} | x{1.2cm} x{1.2cm} | x{1.2cm} x{1.2cm} | x{1.2cm} x{1.2cm}|}
            ...
            &\textbf{Recall} & \textbf{Prec.} & \textbf{Recall} & \textbf{Prec.} & \textbf{Recall} & \textbf{Prec.} & \textbf{Recall} & \textbf{Prec.}\\
            \hline
            Bul. over seg & $0.9434$ & $0.7709$ &$0.9336$ & $0.7766$ &$0.9238$ & $0.7704$ &$0.$ & $0.$ \\
            \hline
            ...
            \hline
            Imprecise height & $0$ & -- & $0$ & -- & $0.0$ & -- &$0.$ & $0.$ \\
            \hline
            \hline
            Fac. over seg & $0.9877$ & $0.9877$ &$0.9887$ & $0.9867$ &$0.9867$ & $0.9847$ &$0.$ & $0.$ \\
            \hline
            Fac. under seg & $0.0070$ & $0.5$ &$0.0070$ & $0.3334$ &$0.0070$ & $0.5$ &$0.$ & $0.$ \\
            \hline
            Fac. inexact seg & $0.0136$ & $0.6667$ &$0.0136$ & $0.5$ &$0.0136$ & $0.2857$ &$0.$ & $0.$ \\
            \hline
            Imprecise slope & $0$ & -- & $0$ & -- & $0.$ & -- &$0.$ & $0.$ \\
            \hline
		\end{tabular}
	\end{center}
