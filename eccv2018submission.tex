...
\begin{figure}
	\begin{center}
    \tiny
		\begin{tabular}{| x{3cm} | x{1cm} | x{1cm} |}
			\multicolumn{3}{x{4cm}}{\includegraphics[height=.11\textheight]{images/prediction_results/valid_as_bul_over}}\\
            & \textbf{G.t} & \textbf{Pred.}\\
            & & \\
		\end{tabular}
