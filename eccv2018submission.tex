...
\begin{figure}
    ...
    \tiny
		\begin{tabular}{| x{1cm} | x{.75cm} | x{.75cm} | x{.5cm} | x{.75cm} | x{.75cm} | x{.5cm} | x{.75cm} | x{.75cm} |}
        	\hline
			\multicolumn{3}{| x{2.5cm} |}{\includegraphics[height=.1\textheight]{images/prediction_results/valid_as_bul_over}} & \multicolumn{3}{ x{2cm} |}{\includegraphics[height=.1\textheight]{images/prediction_results/no_imprec_no_fac_over}} & \multicolumn{3}{ x{2cm} |}{\includegraphics[height=.1\textheight]{images/prediction_results/no_imprec_no_fac_over}}\\
			\hline
