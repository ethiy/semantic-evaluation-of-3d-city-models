	...
	\begin{center}
    	\floatbox{figure}{
            \begin{subfloatrow}[2]
                ...
                \ffigbox[\FBwidth]{\caption{\tiny The green squares represent intersecting pixels with the red segment. The gradient vector in purple is compared to the segment normal in black.}\label{fig::seg_inter}}{\includestandalone[mode=buildnew, width=.33\textwidth]{image_features}}
            \end{subfloatrow}
        }{
