...
\begin{document}
    \begin{tikzpicture}
        ...
        \path (simulated_dsm.south) + (0, -10) node (images) {\includegraphics[width=4cm]{images/orthoimage}};
        \path (model.south) + (9, -10) node (dsm) {\includegraphics[width=4cm]{images/ortho_elanc}};
